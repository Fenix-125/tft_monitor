...
#define PROTOCOL_CHECK_SUM_BYTES 2  // DO NOT CHANGE - uint16_t used to store the actual value
static_assert(PROTOCOL_CHECK_SUM_BYTES == 2, "SHOULD BE 2 - uint16_t used to store the actual value;"
